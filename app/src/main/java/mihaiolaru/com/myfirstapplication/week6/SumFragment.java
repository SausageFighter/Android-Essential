...
public class SumFragment extends Fragment {
    ...
    private void initView (View view) {
        mEditTextNumber1 = view.findViewById(R.id.edittextNumber1);
        mEditTextNumber2 = view.findViewById(R.id.edittextNumber2);
        mButtonGetSum = view.findViewById(R.id.buttonSum);
